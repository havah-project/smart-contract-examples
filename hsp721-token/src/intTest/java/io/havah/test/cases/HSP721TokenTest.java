...
import io.havah.test.score.HSP721TokenScore;
...
public class HSP721TokenTest extends TestBase {
    ...
    @Test
    public void testHSP721Token() throws Exception {
        // 1. deploy
        HSP721TokenScore tokenScore = HSP721TokenScore.mustDeploy(txHandler, ownerWallet);
        ...
        ids[0] = tokenScore.safeTransferFrom(ownerWallet, ownerWallet.getAddress(), caller.getAddress(), token, "safeTransfer".getBytes());
    ...
    private void showTokenStatus(HSP721TokenScore tokenScore) throws Exception {
        if (!DEBUG) { return; }
