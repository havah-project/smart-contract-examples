...
public class LiquidityTokenScore extends Score {
    ...
    public LiquidityTokenScore(Score other) {
        super(other);
    }

    public LiquidityTokenScore(TransactionHandler txHandler, Address scoreAddress) {
        super(txHandler, scoreAddress);
    }

    public static LiquidityTokenScore mustDeploy(TransactionHandler txHandler, Wallet owner, String name, String symbol, BigInteger decimals)
        ...
        LOG.infoExiting();
        return new LiquidityTokenScore(score);
    }
    ...
    public Address minter() throws Exception {
