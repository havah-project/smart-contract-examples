...
public class LiquidityTokenScore extends Score {
    ...
    public static LiquidityTokenScore mustDeploy(TransactionHandler txHandler, Wallet owner, String name, String symbol)
        ...
        RpcObject params = new RpcObject.Builder()
                ...
                .put("_decimals", new RpcValue(BigInteger.valueOf(18)))
                .build();
